...
The Python CLI/SDK, TypeScript SDK and MCP server are published as `v0.2.1`. The release workflow
validates versions, builds distributable artifacts, tests clean installs, then uses protected PyPI
and npm trusted publishing through GitHub OIDC. Install `antops==0.2.1`, `@antops/sdk@0.2.1`, and
`@antops/mcp@0.2.1` from their public registries.
