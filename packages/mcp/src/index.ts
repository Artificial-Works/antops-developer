...
const client = new AntOpsClient({ apiKey, baseUrl: process.env.ANTOPS_BASE_URL, clientId: "mcp/0.2.1" });
const server = new Server({ name: "antops-mcp", version: "0.2.1" }, { capabilities: { tools: {} } });
